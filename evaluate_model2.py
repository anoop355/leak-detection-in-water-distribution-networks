...
def main():
    ...
    parser.add_argument("--results_dir", type=str, default="test_data_results2",
    ...
    for scn_dir in scn_dirs:
        ...
        # Collect sorted pipe lists for scenario-level misclassification log
        ...
        row = {
            ...
            # NEW: scenario-level pipe lists for misclassification analysis
    ...
    # ======================
    # NEW: Pipe misclassification log
    # One row per leak scenario where pipe identification was not a perfect match.
    # Shows true_pipes, pred_pipes, missed_pipes and spurious_pipes per scenario.
    # ======================
    import ast
    ...
    for row in per_rows:
        ...
        if row["fp_pipe"] == 0 and row["fn_pipe"] == 0:
        ...
        # Greedy match to determine which true pipes were hit
        used = set()
        matched_true = []
    ...
    print(f"[OK] Saved pipe misclassification log   : {misclass_path}")
