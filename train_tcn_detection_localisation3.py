...
- reads scenario folders from the ST-GCN dataset
- restricts inputs to `P4`, `Q1a`, and `Q3a`
- keeps the multi-leak heads while testing a smaller sensor configuration
"""
...
torch.save(save_bundle, "leak_tcn_bundle.pt")
print("[OK] Saved leak_tcn_bundle.pt")
