...
SAVE_PATH      = "stgcn_bundle_optionB_25ep.pt"
...
class SingleLeakSTGCN(nn.Module):
    ...
    def forward(self, x):
        ...
        # Pool over time only, retaining node dimension.
        z = x.mean(dim=1)                    # (B, N, HIDDEN_2)
        z = z.reshape(z.size(0), -1)         # (B, N * HIDDEN_2)
...
def main():
    ...
    # Save bundle
    bundle = {
        "model_type": "stgcn_single_leak_v3",
